...
const ChatContainer = () => {
	...
	return (
		<div className="flex items-center  flex-row dark">
			{/* sidebar */}
			<div className="sticky max-sm:hidden basis-1/6 top-0 bottom-0 left-0 z-40 w-64 h-screen">
				...
				<aside id="default-sidebar" className="max-sm:hidden sticky top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
			...
			<div className="relative w-full max-w-full min-h-screen z-40">
				<div className="flex text-white flex-col w-full max-w-full pb-24 ">
					...
					>
						<div className="w-full flex items-center shadow-lg py-4 absolute text-center font-black text-3xl bg-[#1e1e24] top-0">
							<button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
								<span className="sr-only">Open sidebar</span>
								<svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
									<path clipRule="evenodd" fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
							...
							<h1 className="basis-4/5">{currentTitle ? currentTitle : "KiaGPT"}</h1>
						</div>
				...
				<form ref={formRef} onSubmit={handleSubmit} className='fixed bg-[#40414F] bottom-0 right-0  px-10 w-full max-w-5/6 p-3 flex flex-row gap-3'>
					<textarea className='w-full text-white bg-transparent text-base p-3 rounded-lg outline-none focus:ring-gray-600 border-none max-w-full
